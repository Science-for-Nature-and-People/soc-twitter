...
head(tstat_col_caps, 100) %>% arrange(desc(count)) %>% filter(collocation != "soil health" & collocation != "healthy soil"& collocation != "regenerative agriculture" & collocation != "soil fertility" & collocation != "soil quality")
```
...
head(tstat_col_caps_25, 20) %>% arrange(desc(count)) %>% filter(collocation != "soil health" & collocation != "healthy soil"& collocation != "regenerative agriculture" & collocation != "soil fertility" & collocation != "soil quality")
```
...
head(tstat_col_caps_100, 50) %>% arrange(desc(count)) %>% filter(collocation != "soil health" & collocation != "healthy soil"& collocation != "regenerative agriculture" & collocation != "soil fertility" & collocation != "soil quality")
```
...
head(tstat_col_caps_rest, 100) %>% arrange(desc(count)) %>% filter(collocation != "soil health" & collocation != "healthy soil"& collocation != "regenerative agriculture" & collocation != "soil fertility" & collocation != "soil quality")
