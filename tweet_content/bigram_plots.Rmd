...
# 
# limit <- forest_bigram$n[70]
# 
# gram_network(forest_bigram, limit)
```
...
# 
# limit <- range_100_bigram$n[70]
# 
# gram_network(range_100_bigram, limit)
```
