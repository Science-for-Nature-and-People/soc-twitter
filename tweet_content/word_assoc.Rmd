...
top_qual$query = "soil_quality"
top_fertil$query = "soil_fertility"
top_health$query = "soil_health"
...
# filter out all the search terms
top_words <- top_words %>%
  filter(!str_detect(word, 'rangeland|rangeland_health|#rangeland_health|soil_qual|#soil_qual|soil_fertil|#soil_fertil|soil|#soil|soil_health|#soil_health'))
top_words
```
