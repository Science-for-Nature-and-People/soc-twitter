...
```{r, include=FALSE}
### reating dataset for each seach term - this will be used for analysis and to create a figure comparing the sizes of the dataframes produced by each query
...
hit_split <- colsplit(noRT$hits, ';', c('a','b','c','d','e'))
